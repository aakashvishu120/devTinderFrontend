...
const Requests = () => {
    ...
    if (requests.length === 0) return <h1 className='flex justify-center my-10 text-2xl'>No Requests Found</h1>
        ...
        <div className='text-center my-10'>
            <h1 className='text-bold text-4xl text-white'>Requests</h1>
            {
                requests.map((request) => {
                    ...
                    return (
                        <div key={_id} className='flex justify-between items-center m-4 p-4 w-1/2 rounded-lg bg-base-300 mx-auto'>
                            <div>
